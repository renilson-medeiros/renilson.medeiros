      ...
      <div className='w-full max-w-screen-sm flex flex-col'>
        <div className="w-full flex justify-between items-center mb-4">
          ...
          <span className='font-sm text-sm text-gray-200 transition-all hover:text-black-200'>
            <Link to="/projects" className='flex items-center p-2 gap-1 rounded hover:bg-gray-50 transition-all hover:gap-2'> 
              <span>Ver todos</span>
        ...
        <div className='rounded overflow-hidden relative'>
          <span className='absolute top-3 -left-1 z-10 max-[500px]:top-[6px]'>
            <Link to="/case-study">
              <span className='cursor-pointer bg-black-100 hover:bg-black-200 text-gray-50 hover:pl-8 font-semibold relative py-4 px-6 max-[500px]:py-2 rounded hover:no-underline transition-all'>Landing Page de pagamentos</span>
            </Link>
          </span>
          <span className='bg-black-100 py-2 px-4 rounded hover:bg-black-200 bottom-6 right-6 absolute z-10 max-[500px]:bottom-4 max-[500px]:right-4 max-[500px]:py-1'>
            <Link to="/case-study" className='flex gap-1 hover:gap-2 items-center text-gray-50 transition-all'>
              <span>Ver mais</span>
