      ...
      <div className='w-full flex flex-wrap max-w-screen-sm relative items-center'>
        <div className="flex w-full items-center justify-between text-lg flex-wrap max-[500px]:gap-6">
          ...
          <div className='max-[500px]:w-full max-[500px]:flex max-[500px]:justify-center max-[500px]:-mb-6'>
            <ul className='w-full flex justify-start gap-2 max-[500px]:gap-4'>
            
              <li>
                <a className="relative bg-gray-50 w-10 h-10 hover:w-28 rounded flex justify-center items-center hover:bg-black-200 text-black-200 hover:text-gray-50 cursor-pointer transition-all overflow-hidden after:content-['LinkedIn'] font-medium after:justify-start after:items-start hover:gap-2 after:hidden after:hover:block after:text-sm max-[500px]:after:block max-[500px]:w-28 max-[500px]:gap-2" href="https://www.linkedin.com/in/renilsonmedeiros/" target="_blank" title='LinkedIn'>
              ...
              <li>
                <a className="relative bg-gray-50 w-10 h-10 hover:w-28 rounded flex justify-center items-center hover:bg-black-200 text-black-200 hover:text-gray-50 cursor-pointer transition-all overflow-hidden after:content-['GitHub'] font-medium after:justify-start after:items-start hover:gap-2 after:hidden after:hover:block after:text-sm max-[500px]:after:block max-[500px]:w-28 max-[500px]:gap-2" href="https://github.com/renilson-medeiros" target="_blank" title='GitHub'>
              ...
              <Tippy content="Currículo não está disponível">
                <li>
                  <a className="relative bg-gray-50 w-10 h-10 hover:w-28 rounded flex justify-center items-center hover:bg-black-200 text-black-200 hover:text-gray-50 cursor-pointer transition-all overflow-hidden after:content-['Currículo'] font-medium after:justify-start after:items-start hover:gap-2 after:hidden after:hover:block after:text-sm max-[500px]:after:block max-[500px]:w-28 max-[500px]:gap-2" href="#" onClick={(e) => e.preventDefault()}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-download">
