        ...
        <div className="flex w-full items-center justify-between text-lg flex-wrap max-[500px]:gap-6">
          <div className="flex items-center gap-4">
            <div className="w-20 h-20 overflow-hidden rounded">
              <img
                src="https://www.github.com/renilson-medeiros.png"
                alt="Foto de perfil de Renilson Medeiros"
                className="w-full h-full object-cover scale-110"
              />
            </div>
            <div>
              <h1 className="font-semibold text-lg text-black-200">Renilson Medeiros</h1>
              <p className="text-gray-200 font-medium text-base">Desenvolvedor</p>
            </div>
          </div>
            ...
            <ul className="w-full flex justify-start gap-2 max-[500px]:gap-4">
              ...
              <li>
                <a
                  ...
                  href="https://github.com/renilson-medeiros"
                  target="_blank"
                  title="GitHub"
                >
                  <svg
              ...
              <Tippy content="Currículo não está disponível" visible={visible}>
                <li>
                  <a
                    className="relative bg-gray-50 w-10 h-10 hover:w-28 rounded flex justify-center items-center hover:bg-black-200 text-black-200 hover:text-gray-50 cursor-pointer transition-all overflow-hidden after:content-['Currículo'] font-medium after:justify-start after:items-start hover:gap-2 after:hidden after:hover:block after:text-sm max-[500px]:after:block max-[500px]:w-28 max-[500px]:gap-2"
                    href="#"
